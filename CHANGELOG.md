...
### Agregado
- Nueva máquina: PC antiguo con alias `media` (192.168.0.3), x86_64, Intel i5-3470S (4c/4t), 7.7 GiB RAM, 3×1TB (sda OS; sdb/sdc datos sin configurar), Intel HD 2500 (QSV H.264). Pendiente de provisionar.
